...
export default function NotFound() {
  const contactEmail = "info@deshold.com"
    ...
    <>
      ...
      <style>{`
        ...
        .nf-wrap::after {
          ...
          width: 700px;
          height: 700px;
          background: radial-gradient(ellipse, rgba(240, 168, 58, 0.06) 0%, transparent 70%);
          pointer-events: none;
          z-index: 0;
        }
        ...
        .nf-contact a {
          ...
          font-weight: 500;
          border-bottom: 1px solid rgba(240, 168, 58, 0.35);
        }
        ...
        .nf-btn-primary:hover {
          ...
          box-shadow: 0 8px 24px rgba(240, 168, 58, 0.25);
        }
      ...
      <div className="nf-wrap">
        <nav className="nf-topbar">
          <div className="nf-logo">DES<span>.</span>HOLD</div>
